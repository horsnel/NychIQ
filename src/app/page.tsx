    ...
    <div className="flex items-center justify-center min-h-[60vh] animate-fade-in-up">
      <Card className="nychiq-card max-w-md w-full">
        <CardContent className="p-8 text-center">
          <div className="w-14 h-14 rounded-2xl bg-[rgba(246,168,40,0.1)] border border-[rgba(255,255,255,0.06)] flex items-center justify-center mx-auto mb-4">
    ...
    <div className="flex min-h-screen bg-[#0a0a0a]">
      ...
      {isLoggedIn && !sakuOpen && !sakuFullOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-[100] w-14 h-14 rounded-full bg-gradient-to-br from-[#F6A828] to-[#D4921F] flex items-center justify-center shadow-lg shadow-[rgba(246,168,40,0.12)] hover:scale-110 transition-transform animate-saku-glow"
