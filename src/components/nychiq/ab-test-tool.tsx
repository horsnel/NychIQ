  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] animate-fade-in-up">
      <div className="max-w-sm w-full rounded-lg bg-[#111111] border border-[#222222] p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-[#E8E8E8] mb-2">A/B Tester Locked</h2>
        <p className="text-sm text-[#888888] mb-6">This feature requires the Pro plan or higher. Upgrade to test titles and thumbnails.</p>
...
Return ONLY the JSON object.`;
  ...
  if (!canAccess('ab-test')) return <PlanGate />;
