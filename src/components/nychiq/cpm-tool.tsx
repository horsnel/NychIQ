              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[#1A1A1A]">
                    <th className="text-left px-4 py-2.5 text-[11px] font-medium text-[#a0a0a0] uppercase tracking-wider">Niche</th>
                    <th className="text-right px-4 py-2.5 text-[11px] font-medium text-[#a0a0a0] uppercase tracking-wider">CPM</th>
                    <th className="text-right px-4 py-2.5 text-[11px] font-medium text-[#a0a0a0] uppercase tracking-wider">RPM</th>
                    <th className="text-right px-4 py-2.5 text-[11px] font-medium text-[#a0a0a0] uppercase tracking-wider">MoM</th>
                    <th className="text-right px-4 py-2.5 text-[11px] font-medium text-[#a0a0a0] uppercase tracking-wider">Competition</th>
                  </tr>
                </thead>
                  ...
                  {cpmData.map((entry, i) => (
                    ...
                    >
                      ...
                      <td className="text-right px-4 py-3">
                        <span className="text-sm font-semibold text-[#888888]">${entry.cpm.toFixed(2)}</span>
                      </td>
                      <td className="text-right px-4 py-3">
                        <span className="text-sm font-semibold text-[#888888]">${entry.rpm.toFixed(2)}</span>
                      </td>
                      <td className="text-right px-4 py-3">
                        <span className={cn('text-sm font-medium flex items-center justify-end gap-1', entry.change >= 0 ? 'text-[#888888]' : 'text-[#888888]')}>
      ...
      <div className="rounded-lg bg-[#0f0f0f] border border-[rgba(255,255,255,0.03)] overflow-hidden">
        ...
        <div className="p-5">
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-[#a0a0a0] mb-2">Monthly Views</label>
            ...
            {cpmData.length > 0 && (
              <div className="flex items-center gap-2 p-3 rounded-lg bg-[#0a0a0a] border border-[#1A1A1A]">
                ...
                <span className="text-xs text-[#a0a0a0]">Selected:</span>
                <span className="text-xs font-semibold text-[#FFFFFF]">{cpmData[selectedNiche].niche}</span>
                <span className="text-xs text-[#a0a0a0]">(${cpmData[selectedNiche].cpm.toFixed(2)} CPM · ${cpmData[selectedNiche].rpm.toFixed(2)} RPM)</span>
              </div>
            )}
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-lg p-4 bg-[#0a0a0a] border border-[#1A1A1A] text-center">
              <p className="text-[11px] font-medium text-[#a0a0a0] uppercase tracking-wider mb-2">Monthly Revenue</p>
            ...
            <div className="rounded-lg p-4 bg-[#0a0a0a] border border-[#1A1A1A] text-center">
              <p className="text-[11px] font-medium text-[#a0a0a0] uppercase tracking-wider mb-2">Yearly Revenue</p>
              <p className="text-2xl font-bold text-[#888888]">
