  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] animate-fade-in-up">
      <div className="max-w-sm w-full rounded-lg bg-[#111111] border border-[#222222] p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-[#E8E8E8] mb-2">Channel Mentions Locked</h2>
        <p className="text-sm text-[#888888] mb-6">This feature requires the Elite plan or higher. Upgrade to discover who&apos;s talking about any YouTube channel.</p>
...
Return ONLY the JSON array, no other text.`;
  ...
  if (!canAccess('social-mentions')) return <PlanGate />;
    ...
    <div className="space-y-5 animate-fade-in-up">
        ...
        <div className="px-4 sm:px-5 py-4 border-b border-[#1A1A1A]">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#888888] mt-0.5">Find who&apos;s talking about any YouTube channel across platforms</p>
            </div>
          </div>
      ...
      {!loading && searched && mentions.length > 0 && filteredMentions.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <h3 className="text-sm font-semibold text-[#E8E8E8] mb-1">No mentions on {platformFilter}</h3>
