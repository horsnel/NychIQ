...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { font-family: 'Inter', -apple-system, sans-serif; background: #0a0a0a; color: #FFFFFF; padding: 40px; max-width: 800px; margin: 0 auto; }
...
<body>
  ...
  <div style="margin-bottom:30px">
    <h2 style="font-size:11px;font-weight:700;letter-spacing:1.5px;color:#a0a0a0;text-transform:uppercase;margin-bottom:16px">Category Scores</h2>
    ${categoriesHtml}
  </div>

  <div style="margin-bottom:30px">
    <h2 style="font-size:11px;font-weight:700;letter-spacing:1.5px;color:#a0a0a0;text-transform:uppercase;margin-bottom:16px">Action Items</h2>
    ${actionItemsHtml}
  </div>
  ...
  <div style="text-align:center;margin-top:40px;padding-top:20px;border-top:1px solid #0f0f0f">
    <div style="font-size:10px;color:#666666">Generated by NychIQ Channel Audit Tool</div>
  </div>
</body>
</html>`;
...
Return ONLY the JSON object.`;
  ...
  return (
    <div className="space-y-5 animate-fade-in-up">
      ...
      {searched && !loading && <div className="text-center text-[11px] text-[#666666]">Cost: {TOKEN_COSTS.audit} tokens per audit</div>}
    </div>
  );
}
