    ...
    <div className="space-y-5 animate-fade-in-up">
      ...
      {!loading && result && (
        <div className="space-y-4">
          <h3 className="text-sm font-semibold text-[#FFFFFF] flex items-center gap-2"><Sparkles className="w-4 h-4 text-[#EF4444]" /> Forensics Report</h3>
      ...
      {!loading && !searched && (
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-sm text-[#A3A3A3] max-w-xs text-center">Paste a video URL to get a forensic analysis of why it underperformed.</p>
        </div>
      )}
