...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-[#070707] border-t border-[#1E1E1E]">
        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex flex-col items-center justify-center gap-1 px-3 py-1.5 rounded-lg transition-colors',
