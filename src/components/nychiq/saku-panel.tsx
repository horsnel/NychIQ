...
function TypingIndicator() {
  return (
    <div className="flex items-start gap-2 animate-fade-in-up">
      <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-[#9B72CF] to-[#F5A623] flex items-center justify-center shrink-0">
...
export function SakuPanel() {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed bottom-4 right-4 z-50 w-[380px] max-w-[calc(100vw-2rem)] bg-[#111] border border-[#222] rounded-xl shadow-2xl flex flex-col animate-fade-in-up lg:bottom-5 lg:right-5"
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-[#1E1E1E] shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#9B72CF] to-[#F5A623] flex items-center justify-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <p className="text-[10px] text-[#00C48C]">Online</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 no-scrollbar">
          ...
          {messages.length === 0 && !isTyping && (
            <div className="text-center py-4">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#9B72CF] to-[#F5A623] flex items-center justify-center mx-auto mb-3">
              ...
              <div className="space-y-2">
                {SUGGESTIONS.map((sug) => (
                  ...
                  >
                    <sug.icon className="w-3.5 h-3.5 text-[#555] group-hover:text-[#F5A623] transition-colors shrink-0" />
          ...
          {messages.map((msg, i) => (
            ...
            >
              {msg.role === 'assistant' && (
                <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-[#9B72CF] to-[#F5A623] flex items-center justify-center shrink-0 mt-0.5">
                  <Bot className="w-3.5 h-3.5 text-black" />
                </div>
              )}
              <div
        ...
        <div className="p-3 pt-2 border-t border-[#1E1E1E] shrink-0">
          <div className="flex items-center gap-2 bg-[#1A1A1A] rounded-xl px-3.5 py-2.5 border border-[#222] focus-within:border-[rgba(245,166,35,0.3)] transition-colors">
            <input
              ref={inputRef}
              type="text"
              value={input}
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-[#F5A623] hover:bg-[rgba(245,166,35,0.1)] disabled:text-[#333] disabled:hover:bg-transparent transition-colors"
            >
